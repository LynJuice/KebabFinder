        ...
        <div class="modal-content">
            ...
            <form id='editInformation' action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <input name="image" class="form-control" type="file" id="kebab_image_edit" value="{{ old('image')}}">
                    @error('image')
                    <small>{{ $message }}</small><br>
                    @enderror

                    <br><label for="logo_image_edit" class="form-label">Logotipas</label>
                    <input name="logo" class="form-control" type="file" id="logo_image_edit" value="{{ old('logo') }}">
                    @error('logo')
                    <small>{{ $message }}</small><br>
                    @enderror
