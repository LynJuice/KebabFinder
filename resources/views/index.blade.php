        ...
        <div class="tab-pane fade active show" id="menu-starters">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 menu-item" ">
                <a href=" {{ asset('images/products/' . $product->image) }}" class="glightbox"><img src="{{ asset('images/products/' . $product->image) }}" class="menu-img img-fluid" style="height:250px" alt=""></a>
              <h4>{{ $product->name }}</h4>
              <p class="ingredients">
                {{$product->description}}
              </p>
    ...
    <div class="container-fluid" data-aos="fade-up">
      ...
      <div class="slides-3 swiper" data-aos="fade-up" data-aos-delay="100">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide event-item d-flex flex-column justify-content-end" style="background-image: url({{asset('images/diners/photos/' . $item->image) }})">
            <h3>{{ $item->name }}</h3>
