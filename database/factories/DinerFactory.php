...
class DinerFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'latitude' => $kebab[$kebab_nr][1] + (fake()->numberBetween(-100, 100) / 10000),
            // 'latitude' => $this->faker->latitude,
            'longitude' => $kebab[$kebab_nr][2] + (fake()->numberBetween(-100, 100) / 10000),
            ...
            'logo' => "menu-item-" . fake()->numberBetween(1, 7) . ".png",
        ];
    }
}
